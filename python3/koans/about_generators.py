...
class AboutGenerators(Koan):
    ...
    def test_generating_values_on_the_fly(self):
        ...
        self.assertEqual(['crunchy bacon',
                          'veggie bacon',
                          'danish bacon'], result)
    ...
    def test_generators_are_different_to_list_comprehensions(self):
        ...
        # tips 'generator' object is not subscriptable
    ...
    def test_before_sending_a_value_to_a_generator_next_must_be_called(self):
        ...
        try:
          ...
          ex2 = ex
        # tips can't send non-None value to a just-started generator
        self.assertRegexpMatches(ex2.args[0], 'value to a just-started generator')
