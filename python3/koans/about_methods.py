...
class AboutMethods(Koan):
    ...
    def test_calling_functions_with_wrong_number_of_arguments(self):
        ...
        self.assertRegexpMatches(msg, 'takes exactly 2')
    ...
    def test_the_documentation_can_be_viewed_with_the_doc_method(self):
        self.assertRegexpMatches(self.method_with_documentation.__doc__, 'function')
    ...
    class Dog:
        def name(self):
            return "Fido"
        #tips make it private, but you can still use it
        def _tail(self):
            # Prefixing a method with an underscore implies private scope
            return "wagging"
        #tips name mangle with class name
